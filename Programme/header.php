...
<head>
    ...
    <link href="<?php for ($i = 0; $i < $nbSaut; $i++) {
                    echo "../";
                } ?>bootstrap-5.1.3-dist/css/bootstrap.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css">
    <link rel="stylesheet" href="<?php for ($i = 0; $i < $nbSaut; $i++) {
                                        echo "../";
                                    } ?>style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/css/bootstrap-datepicker.min.css">
    <script src="<?php for ($i = 0; $i < $nbSaut; $i++) {
                        echo "../";
                    } ?>bootstrap-5.1.3-dist/js/bootstrap.js"></script>
    <script src="<?php for ($i = 0; $i < $nbSaut; $i++) {
                        echo "../";
                    } ?>script.js"></script>
</head>
...
<body>
    ...
    session_start();
    if (!$_SESSION['role'] && !$_SESSION['nom']) {
        header("Location: Login/login.php");
    } else {
        $role = $_SESSION['role'];
        $nomPrenomUser = $_SESSION['nom'];
    }
    ...
    <div class="container">
        <nav class="navbar">
            <div class="d-flex justify-content-start">
                <a class="navbar-brand logo" href="<?php for ($i = 1; $i < $nbSaut; $i++) {
                                                        echo "../";
                                                    } ?>index.php">
                    <img class="" src="<?php for ($i = 0; $i < $nbSaut; $i++) {
                                            echo "../";
                                        } ?>img/logo.png" alt="" width="100%">
                </a>
